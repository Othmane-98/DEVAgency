           ...
           >
             ...
             <div className="group flex items-start gap-4 p-6 rounded-3xl border border-border/50 bg-card/30 backdrop-blur-sm hover:bg-card/80 transition-all hover:border-primary/50">
                ...
                <div>
                  ...
                  <a href={`mailto:${siteConfig.email}`} className="text-muted-foreground mt-1 hover:text-primary transition-colors block">
                    {siteConfig.email}
                  </a>
             ...
             <div className="group flex items-start gap-4 p-6 rounded-3xl border border-border/50 bg-card/30 backdrop-blur-sm hover:bg-card/80 transition-all hover:border-primary/50">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1 block">{siteConfig.address}</p>
                </div>
             </div>
           </motion.div>
