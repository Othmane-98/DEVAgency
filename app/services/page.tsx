...
import { ArrowRightIcon, CheckIcon, Cpu, ShoppingCart, Users, Zap, Search, ShieldCheck } from "lucide-react";
          ...
          {serviceCards.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 w-full bg-accent/30 rounded-2xl border border-border/40 aspect-video flex-center p-6 lg:p-12 relative shadow-inner">
