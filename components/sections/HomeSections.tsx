...
import { serviceCards, stats, testimonials, pricingPlans, faqItems, features } from "@/content/site-content";
            ...
            >
              ...
              <div className="mt-6 flex items-baseline gap-1 border-b border-border/50 pb-8">
                {plan.price === "Sur mesure" ? (
                  ...
                  <>
                    <span className="text-xl font-medium text-muted-foreground mr-1">Dès</span>
                    <span className="text-5xl font-bold tracking-tight text-foreground">{plan.price}<span className="text-2xl">$</span></span>
                    <span className="text-base font-medium text-muted-foreground">/projet</span>
                  </>
                )}
              </div>
